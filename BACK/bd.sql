...
CREATE TABLE STORY (
    ...
    MONTH_YEAR CHAR(10) NOT NULL UNIQUE,
    DESCRIPTION TEXT,
    ACTIVE TINYINT(1) NOT NULL DEFAULT 1,
    CREATION_DATE DATETIME DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE SYSTEM_EVENT (
    ...
    ACTOR_TYPE ENUM('ADMIN','USER','PENDING','SYSTEM') NOT NULL,
    ACTOR_ID INT UNSIGNED NULL,
    TARGET_TYPE ENUM('ADMIN','USER','PENDING','GAME','PAYMENT','STORY','NONE') NOT NULL,
    TARGET_ID INT UNSIGNED NULL,
    EVENT_TYPE VARCHAR(100) NOT NULL,
    CATEGORY ENUM('AUTH', 'USER_MANAGEMENT', 'GAME_MANAGEMENT', 'GAMEPLAY', 'REWARDS', 'PAYMENT', 'NOTIFICATION', 'SYSTEM') NOT NULL,
    DESCRIPTION TEXT,
